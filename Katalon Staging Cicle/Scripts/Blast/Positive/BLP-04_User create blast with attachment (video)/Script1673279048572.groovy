...
WebUI.uploadFile(findTestObject('Blast/Send attachment (photo)'), 'C:\\Users\\62812\\Videos\\Delete label.mp4')
...
WebUI.click(findTestObject('Blast/Choose blast (video)'))

WebUI.verifyElementVisible(findTestObject('Blast/Video element'), FailureHandling.STOP_ON_FAILURE)
