...
WebUI.uploadFile(findTestObject('Blast/Send attachment (photo)'), 'C:\\Users\\62812\\Documents\\MAGANG\\Error writing notification.xlsx')
...
WebUI.click(findTestObject('Blast/Choose blast (file)'))

WebUI.verifyElementVisible(findTestObject('Blast/File element'), FailureHandling.STOP_ON_FAILURE)
